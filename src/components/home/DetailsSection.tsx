...
export function DetailsSection() {
  ...
  return (
    <section id="philosophy" className="relative w-full min-h-screen flex flex-col justify-center bg-white overflow-hidden py-12 sm:py-24 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24">
      ...
      <div className="relative z-20 w-full max-w-[2000px] mx-auto mt-12 sm:mt-24 flex items-center justify-start pt-8 pl-0 lg:pl-12 xl:pl-24">
        <motion.p 
          initial={{ opacity: 0 }}
